...
- Combat phase one: attacker selection, targeting, and result presentation.
	- Step one: attacker selection and orange range preview from the left rail. Done.
	- Support dynamic attacker lists by role: Onion shows available weapons; defender shows available units. Done.
	- Support ctrl-left click and sidebar selection for one or more eligible attackers. Done.
	- Render orange attack-range overlays, including intersection highlighting for combined attackers. Done.
