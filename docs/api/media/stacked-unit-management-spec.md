...
**Status:** Implementation complete. Canonical roster/naming lifecycle, stack-aware movement and combat, web presentation, and automated regression/E2E coverage are complete.
...
The game state carries one bundled stack-roster element so the engine, API, and UI can pass stack state around without reconstructing it from loose unit records.
...
- [x] **Test stack formation, splitting, merging, and naming**
...
- [x] **Fold finalized stacking rules into docs/game-rules.md**
  *Definition of Done:* Main rules doc is updated with all stacking logic and examples.

- [x] **Fold finalized UI/UX patterns into docs/web-ui-spec.md**
  *Definition of Done:* UI spec includes all stack-related patterns, visuals, and flows.

- [x] **Update scenario authoring and engine docs for stack rules**
