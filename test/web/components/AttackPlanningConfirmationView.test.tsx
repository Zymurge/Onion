...
describe('AttackPlanningConfirmationView', () => {
  it('renders build mode without target stats', () => {
    ...
    expect(screen.getAllByTestId('combat-confirmation-view')[0].querySelectorAll('.combat-confirmation-stat-row')).toHaveLength(1)
  ...
  it('renders confirm mode with defense and odds', () => {
    ...
    expect(screen.getByTestId('combat-confirmation-view').querySelectorAll('.combat-confirmation-stat-row')).toHaveLength(2)
  })
