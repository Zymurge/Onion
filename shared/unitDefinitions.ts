...
const UNIT_DEFINITIONS: Record<UnitType, UnitDefinition> = {
  ...
  TheOnion: {
    ...
    weapons: [
      ...
      makeWeapon('ap_1', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_2', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_3', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_4', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_5', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_6', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_7', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
      makeWeapon('ap_8', 'AP Gun', 1, 1, 1, true, { allowedTargetUnitTypes: ['LittlePigs', 'Castle', 'Swamp'] }, 'AP Gun {{ordinal}}'),
